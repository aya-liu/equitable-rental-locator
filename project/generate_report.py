...
def generate_map(locator_database, blocks_zillow_merge):
  #preparing data for map
  count_series = locator_database.groupby('GEOID').size()
  new_df = pd.DataFrame()
  new_df['GEOID'] = count_series.index
  city_blocks = blocks_zillow_merge[['statefp10', 'name10', 'blockce10', 'tract_bloc', 'geoid10', 'tractce10', 'countyfp10', 'geometry', 'GEOID']]
  ...
  fig.savefig("CHA-map-of-properties.png", dpi=300)
